...
if con.State=1 then
	...
	Case "EDIT"
		...
		rs("group") = GROUP
		rs("age") = AGE				
		rs("progress") = Replace(PROGRESS, ".", ",")
		rs("photo") = Replace(PHOTO, ",", ".")	
		rs.Update
		rs.Requery	
...
<h1><center><font color=3f3f3f>Изменение данных о студенте</font></center></h1>
<br>


<form name="db_add" action="db_edit.asp" method="post">
